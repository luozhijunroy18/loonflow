    ...
    def get_ticket_flow_step(cls, ticket_id: int, username: str)->tuple:
        ...
        for state_obj in state_objs:
            if state_obj.id == ticket_obj.state_id or (not state_obj.is_hidden):
                ticket_state_step_dict = dict(state_id=state_obj.id, state_name=state_obj.name, order_id=state_obj.order_id, participant_type_id=state_obj.participant_type_id, participant=state_obj.participant)
                state_flow_log_list = []
